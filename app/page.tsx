        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                name: "Marc D.",
                role: "Artisan peintre, Nice",
                text: "Je compare systématiquement les prix de la peinture entre Tollens, Leroy Merlin et Brico Dépôt avant chaque chantier. BatiPrix me fait gagner du temps et de l'argent.",
                saving: "~200€/mois",
              },
              {
                name: "Sophie L.",
                role: "Particulière en rénovation, Antibes",
                text: "En rénovant ma salle de bain, j'ai économisé plus de 800€ en comparant les prix du carrelage et de la robinetterie entre 4 enseignes. La carte des magasins est super pratique.",
                saving: "800€ économisés",
              },
              {
                name: "Thomas R.",
                role: "Chef de chantier, Toulon",
                text: "Pour les gros volumes de matériaux, chaque euro compte. BatiPrix me permet de voir en un clin d'œil quel négoce propose le meilleur prix sur le ciment et la visserie.",
                saving: "~15% d'économie",
              },
            ].map((testimonial) => (
              <div
                key={testimonial.name}
                className="bg-cream/50 rounded-2xl border border-cream-dark/20 p-6 hover:shadow-lg transition-shadow"
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="bg-green-deal/10 text-green-deal text-xs font-bold px-2 py-1 rounded-full">
                    {testimonial.saving}
                  </div>
                </div>
              </div>
